...
MODEL_PATH = "model/signal/converted/model_signal.tflite"  # path to the converted tensorflow model
SAVE_TO_PATH = "model/signal/converted/model_signal_metadata.tflite"  # save path for the model with metadata
